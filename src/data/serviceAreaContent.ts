...
export const serviceAreaContent: ServiceAreaContent[] = [
  ...
  },
  {
    ...
    heroSubhead: "Bespoke Auto Design coordinates ferry-terminal concierge transport for Fisher Island clients — your vehicle is collected mainland-side, installed in our climate-controlled Doral studio, and returned camera-ready with content-quality before-and-after documentation.",
    why: [
    ...
    faq: [
      ...
      { question: "Do you document the install?", answer: "Yes — every install gets photo and video documentation under controlled lighting, which you're welcome to use and we share on our Instagram (@bespokeautodesign) when you approve." },
    ...
    metaDescription: "XPEL paint protection film, ceramic coating, and window tint for Fisher Island residents. Ferry-terminal concierge pickup, climate-controlled install, content-quality before-and-after. (786) 395-9172. @bespokeautodesign",
  },
  {
    slug: "star-island",
    name: "Star Island",
    ...
    heroSubhead: "Bespoke Auto Design coordinates concierge transport from Star Island via the MacArthur Causeway — your supercar is protected in our climate-controlled Doral studio and returned camera-ready with full before-and-after documentation worth posting.",
    why: [
    ...
    faq: [
      ...
      { question: "Do you document the install for social content?", answer: "Yes — every install is shot under controlled lighting. You get the content for your channels, and featured builds get posted to our Instagram (@bespokeautodesign) when you approve." },
    ...
    metaDescription: "XPEL paint protection film, ceramic coating, and tint for Star Island residents. MacArthur Causeway concierge pickup, climate-controlled install bay, content-quality documentation. (786) 395-9172. @bespokeautodesign",
  },
  {
    slug: "indian-creek",
    name: "Indian Creek",
    ...
    heroSubhead: "Bespoke Auto Design provides full-concierge XPEL paint protection, ceramic coating, and tint for Indian Creek's 41 residences — bridge-side pickup, climate-controlled installation, and content-quality before-and-afters delivered straight to you.",
    why: [
    ...
    faq: [
      ...
      { question: "Do you document the install?", answer: "Yes — every install gets photo and video documentation under controlled lighting. You get the content; featured builds also land on our Instagram (@bespokeautodesign) when you approve." },
    ...
    metaDescription: "XPEL paint protection film, ceramic coating, and tint for Indian Creek residents. Bridge-side concierge pickup, climate-controlled install bay, content-quality documentation. (786) 395-9172. @bespokeautodesign",
  },
  {
    slug: "surfside",
    name: "Surfside",
