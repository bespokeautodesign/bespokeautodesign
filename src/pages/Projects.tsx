              ...
              <Card key={project.id} className="group overflow-hidden hover:shadow-elegant transition-all duration-300">
                <div className="relative overflow-hidden">
                  <img
                    src={project.image}
                    alt={project.title}
                    className={`w-full h-64 object-cover transition-transform duration-300 group-hover:scale-105 ${project.id === 1 ? 'object-[center_65%]' : ''} ${project.id === 3 ? 'object-[center_55%]' : ''} ${project.id === 4 ? 'object-[center_45%]' : ''} ${project.id === 5 ? 'object-[center_75%]' : ''}`}
                  />
