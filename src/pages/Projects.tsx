...
import ceramicTintImage from "/lovable-uploads/85ac03b2-7e26-4573-80f5-a2cdbb10cd1f.webp";
...
const Projects = () => {
  ...
  const projects = [
    {
      ...
      image: "/lovable-uploads/ferrari-laferrari-shop-enhanced.webp",
    ...
    },
    {
      ...
      image: "/lovable-uploads/0043b483-74ac-46c5-916a-44e46e97b88b.webp",
    ...
    },
    {
      ...
      image: "/lovable-uploads/3f1daf49-c3df-4080-ae59-f3d51dde5a5e.webp",
    ...
    },
    {
      ...
      image: "/lovable-uploads/954a24eb-a0e4-4854-a5ae-cc3558261924.webp",
    ...
    },
    {
      ...
      image: "/lovable-uploads/2b4efeb0-51dc-4e2f-b7e3-9c4e9882c48e.webp",
    ...
    },
    {
      ...
      image: "/lovable-uploads/171000e1-8047-462c-b8fd-a3e367867858.webp",
  ...
  const clearPPFVehicles = [
    { id: 1, name: "Ferrari California T", image: "/lovable-uploads/ferrari-california-t.webp", year: "2018" },
    { id: 2, name: "Rolls-Royce Cullinan", image: "/lovable-uploads/rolls-royce-cullinan.webp", year: "2022" },
    { id: 3, name: "Ferrari LaFerrari", image: "/lovable-uploads/ferrari-laferrari-shop-enhanced.webp", year: "2016" },
    { id: 4, name: "Aston Martin Vantage", image: "/lovable-uploads/06b4e251-b273-487e-8f43-394aa71342f8.webp", year: "2021" },
    { id: 5, name: "2024 BMW M4", image: "/lovable-uploads/2ba942d5-5b05-4d45-8455-fd19f9b765c6.webp", year: "2024" },
    { id: 6, name: "Ferrari F8 Tributo", image: "/lovable-uploads/3f1daf49-c3df-4080-ae59-f3d51dde5a5e.webp", year: "2020" },
    { id: 7, name: "2024 Corvette Stingray", image: "/lovable-uploads/e1a77901-cd16-499b-9d39-f725cce775d5.webp", year: "2024" },
    { id: 8, name: "Toyota Land Cruiser", image: "/lovable-uploads/fdf28998-66d9-4078-980c-8d7cb1c0485f.webp", year: "2024" },
    { id: 9, name: "Ram 1500", image: "/lovable-uploads/f14f599e-ddd2-47ac-ae95-ffbcd59b8f60.webp", year: "2023" },
    { id: 10, name: "Corvette Z06", image: "/lovable-uploads/e456804b-63fa-4640-bebe-d3ade09ef953.webp", year: "2023" },
    { id: 11, name: "Tesla Model 3", image: "/lovable-uploads/a777b2aa-1d9f-42db-9b41-327227b99e44.webp", year: "2024" }
  ];

  // Stealth PPF vehicle showcases
  const stealthPPFVehicles = [
    { id: 1, name: "Porsche Carrera", image: "/lovable-uploads/porsche-carrera.webp", year: "2024" },
    { id: 2, name: "Mercedes G-Wagon G63 AMG", image: "/lovable-uploads/954a24eb-a0e4-4854-a5ae-cc3558261924.webp", year: "2025" },
    { id: 3, name: "2024 BMW M2", image: "/lovable-uploads/2a622203-bfde-4c8c-99bb-c9fb7ee08311.webp", year: "2024" },
    { id: 4, name: "BMW X5", image: "/lovable-uploads/da44c7f8-8dcf-47d1-81f6-9171955481d6.webp", year: "2024" },
    { id: 5, name: "Mercedes GLC 300 AMG", image: "/lovable-uploads/f9e187dd-581d-4e92-8353-50180501ec8a.webp", year: "2023" },
    { id: 6, name: "Porsche 911", image: "/lovable-uploads/562b3389-466e-41a1-ac50-df897f65bde7.webp", year: "2024" },
    { id: 7, name: "Porsche Taycan", image: "/lovable-uploads/d315e50e-7d7b-4141-91a7-0c12cbb561b1.webp", year: "2023" },
    { id: 8, name: "Tesla Model Y", image: "/lovable-uploads/357fab8a-95e2-43dc-a92f-5e792952f28e.webp", year: "2024" }
  ];

  // Vinyl Wrap vehicle showcases
  const vinylWrapVehicles = [
    { id: 1, name: "Aston Martin DBX", beforeImage: "/lovable-uploads/714ade11-8742-4c61-b8fc-1577ddc3dceb.webp", afterImage: "/lovable-uploads/19163148-510a-4a7c-9bb2-ba187ab86dc4.webp", year: "2023" },
    { id: 2, name: "Mazda Miata", beforeImage: "/lovable-uploads/6313432b-9fe6-44eb-82af-82cd8cf3bc37.webp", afterImage: "/lovable-uploads/57c73f3f-f506-407c-949f-9b6266f61d81.webp", year: "2023" },
    { id: 3, name: "McLaren 570S", beforeImage: "/lovable-uploads/0e6ef2c1-78f7-410c-a663-0c83402a98d5.webp", afterImage: "/lovable-uploads/067b368c-69cf-4e91-a81e-01263ad83820.webp", year: "2019" }
  ];
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url(/lovable-uploads/ab1ac973-95da-4423-878b-7808fe62cc38.webp)`
        }}
      ></div>
                        ...
                        <img
                          ...
                          alt={vehicle.name}
                           className={`w-full h-48 object-cover transition-transform duration-300 group-hover:scale-105 ${
                             vehicle.name === "Ferrari California T" ? "object-[center_60%]" :
                             vehicle.name === "Rolls-Royce Cullinan" ? "object-[center_65%]" :
