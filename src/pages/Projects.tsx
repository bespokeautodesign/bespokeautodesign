                       ...
                       <div className="relative overflow-hidden">
                         <div className="relative">
                           <img
                             ...
                             className="w-full h-48 object-cover object-center transition-all duration-500 group-hover:opacity-0"
                           />
                           <img
                             src={vehicle.afterImage}
                             alt={`${vehicle.name} - After`}
                             className="absolute inset-0 w-full h-48 object-cover object-center transition-all duration-500 opacity-0 group-hover:opacity-100"
                           />
                         </div>
                         <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
