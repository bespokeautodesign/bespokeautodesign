...
const Projects = () => {
  ...
  const stealthPPFVehicles = [
    ...
    { id: 3, name: "2025 Mercedes G-Wagon G63 AMG", image: "/lovable-uploads/954a24eb-a0e4-4854-a5ae-cc3558261924.png", year: "2025" },
                        ...
                        <img
                          ...
                          alt={vehicle.name}
                           className={`w-full h-48 object-cover transition-transform duration-300 group-hover:scale-105 ${
                             ...
                             vehicle.name === "BMW X5" ? "" : 
                             vehicle.name === "2025 Mercedes G-Wagon G63 AMG" ? "object-[center_45%] scale-85" :
              ...
              <Card key={project.id} className="group overflow-hidden hover:shadow-elegant transition-all duration-300">
                <div className="relative overflow-hidden">
                  <img
                    src={project.image}
                    alt={project.title}
                    className={`w-full h-64 object-cover transition-transform duration-300 group-hover:scale-105 ${project.id === 1 ? 'object-[center_65%]' : ''} ${project.id === 4 ? 'object-[center_75%]' : ''}`}
                  />
