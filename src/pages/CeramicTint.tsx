    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link to="/ceramic-tint" className="text-primary font-semibold transition-colors">Ceramic Tint</Link>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 font-playfair">Ceramic Tint</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Premium ceramic window tinting in Miami. Content coming soon.
          </p>
