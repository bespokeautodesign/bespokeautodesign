  ...
  <div className="min-h-screen bg-[#0f0f0f] text-[#e5e5e5]">
    ...
    <section className="relative pt-28 pb-20 md:pt-36 md:pb-28 px-4 bg-gradient-to-b from-[#0f0f0f] via-[#141414] to-[#0f0f0f]">
      <div className="max-w-4xl mx-auto text-center">
        <p className="eyebrow-tag">Boutique Auto Protection · CORAL GABLES</p>
        <h1 className="font-sans text-[clamp(30px,5vw,54px)] font-medium text-white mb-6 leading-[1.05] uppercase tracking-[0.02em]">Premium PPF, Ceramic Coating & Window Tint in<br /><span className="text-brand-red">Coral Gables</span>, Miami</h1>
