...
import { Shield, Sun, Droplet, Phone, Mail, MapPin, Clock, Anchor, Waves, ArrowRight, Calendar } from "lucide-react";
      ...
      <section className="relative text-primary-foreground py-32 md:py-36">
        <div className="container mx-auto px-6 relative z-10">
          <header className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight font-playfair">Xpel Premier Paint Protection Film (PPF) Installation in Miami
